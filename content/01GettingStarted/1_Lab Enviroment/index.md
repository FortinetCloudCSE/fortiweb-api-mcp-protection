...
Review the training environment and become familiar with the lab topology.
...
| linux-docker-1 | Juice Shop, DVWA | `10.10.1.200` |
| linux-docker-2 | Petstore, crAPI, MCP | `10.10.1.202` |
